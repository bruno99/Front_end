...
const ABody:FC<{text:string}>=({text})=>{
    ...
    const[url,setUrl]=useState<string>("http://openlibrary.org/search.json?author_name="+text)
            ...
            {data&&<div className="grind">
                ...
                if((index>=minIndex)&&(index<maxIndex)){
                    return (<div className="box">
                        ...
                        {element.cover_i&&<div style={{backgroundImage:"url(http://covers.openlibrary.org/b/id/"+element.cover_i+"-M.jpg",height:"200px",width:"180px",justifySelf:"center", marginBottom:"10px"}}></div>}
                        <div className="texto_title">title: {element.title}</div>
